...
static const TokenType keywordTokenTypeMap[] = {
    ...
    [KEYWORD_TOKEN_DOUBLE] = DOUBLE_KEYWORD,
    [KEYWORD_TOKEN_DEFAULT] = DEFAULT_KEYWORD,
    [KEYWORD_TOKEN_SIGNED] = SIGNED,
    [KEYWORD_TOKEN_UNSIGNED] = UNSIGNED,
...
static const TokenType singleCharTokenTypeMap[] = {
    ...
    [SINGLE_CHAR_TOKEN_OPEN_BRACKET] = OPEN_BRACKET,
    [SINGLE_CHAR_TOKEN_CLOSE_BRACKET] = CLOSE_BRACKET,
...
const char *tokenTypeStr[] = {
    ...
    [UNSIGNED_LONG_CONSTANT] = "UNSIGNED_LONG_CONSTANT",
